...
variant_for_slice()
{
  ...
  "AgoraContentInspectExtension.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "AgoraDrmLoaderExtension.xcframework/ios-arm64_armv7")
    echo ""
    ;;
  "AgoraDrmLoaderExtension.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraAiEchoCancellationExtension.xcframework" "AgoraRtcEngine_iOS/AIAEC" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraAiNoiseSuppressionExtension.xcframework" "AgoraRtcEngine_iOS/AINS" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraClearVisionExtension.xcframework" "AgoraRtcEngine_iOS/ClearVision" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraDrmLoaderExtension.xcframework" "AgoraRtcEngine_iOS/DRM" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraFaceDetectionExtension.xcframework" "AgoraRtcEngine_iOS/FaceDetection" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraReplayKitExtension.xcframework" "AgoraRtcEngine_iOS/ReplayKit" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraCore.xcframework" "AgoraRtcEngine_iOS/RtcBasic" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/Agoraffmpeg.xcframework" "AgoraRtcEngine_iOS/RtcBasic" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraVideoDecoderExtension.xcframework" "AgoraRtcEngine_iOS/VideoCodecDec" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraVideoEncoderExtension.xcframework" "AgoraRtcEngine_iOS/VideoCodecEnc" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/video_enc.xcframework" "AgoraRtcEngine_iOS/VideoCodecEnc" "framework" "ios-arm64_x86_64-simulator" "ios-arm64_armv7"
