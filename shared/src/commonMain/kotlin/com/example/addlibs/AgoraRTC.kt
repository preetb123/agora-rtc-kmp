...
sealed interface JoinChannelListenerEvent {
  ...
  data class OnJoinSuccess(val channel: String?, val uid: Int, val elapsed: Int) :
    JoinChannelListenerEvent

  data class OnJoinChannelError(val errorCode: Int, val errorMessage: String) :
    JoinChannelListenerEvent
}
...
sealed interface LeaveChannelListenerEvent {
  ...
  data class OnLeaveChannelError(val errorCode: Int, val errorMessage: String) :
    LeaveChannelListenerEvent
}
